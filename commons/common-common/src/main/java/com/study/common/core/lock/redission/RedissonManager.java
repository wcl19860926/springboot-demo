...
import com.study.common.core.lock.redission.config.impl.ClusterConfigImpl;
import com.study.common.core.lock.redission.config.impl.MasterslaveConfigImpl;
import com.study.common.core.lock.redission.config.impl.SentineConfigImpl;
import com.study.common.core.lock.redission.config.impl.StandaloneConfigImpl;
import com.study.common.core.redis.constants.RedisConnectionType;
...
public class RedissonManager {
    ...
    public RedissonManager(RedissionProperties redissonProperties) {
        try {
            //通过不同部署方式获得不同cofig实体
    ...
    static class RedissonConfigFactory {
         ...
         * @return Config
         */
        Config createConfig(RedissionProperties redissonProperties) {
