package com.study.export.excel.write;
...
public class ExcelExportWriter<T> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExcelExportWriter.class);
    ...
    public ExcelExportWriter(Map<String, String> header, String titile) throws ExportException {
        super();
        this.titile = titile;
    ...
    static class ExcelsheetWriter {
         ...
         */
        void insertDataRow(Object obj, Class<?> cls, int colIndex) throws IOException, Exception {
            _rownum++;
