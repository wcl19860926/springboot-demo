...
import com.study.core.exception.IORuntimeException;
import com.study.core.io.FastByteArrayOutputStream;
import com.study.core.io.FileUtil;
import com.study.core.io.IoUtil;
...
public class ZipUtil {
	 ...
	 */
	public static File zip(String srcPath) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(String srcPath, Charset charset) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(File srcFile, Charset charset) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(String srcPath, String zipPath) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(String srcPath, String zipPath, boolean withSrcDir) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(String srcPath, String zipPath, Charset charset, boolean withSrcDir) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(File zipFile, boolean withSrcDir, File... srcFiles) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File zip(File zipFile, Charset charset, boolean withSrcDir, File... srcFiles) throws Exception {
	 ...
	 * @since 3.0.6
	 */
	public static File zip(File zipFile, String path, String data) throws Exception {
	 ...
	 * @since 3.2.2
	 */
	public static File zip(File zipFile, String path, String data, Charset charset) throws Exception {
	 ...
	 * @since 3.0.6
	 */
	public static File zip(File zipFile, String path, InputStream in) throws Exception {
	 ...
	 * @since 3.2.2
	 */
	public static File zip(File zipFile, String path, InputStream in, Charset charset) throws Exception {
	 ...
	 * @since 3.0.9
	 */
	public static File zip(File zipFile, String[] paths, InputStream[] ins) throws Exception {
	 ...
	 * @since 3.0.9
	 */
	public static File zip(File zipFile, String[] paths, InputStream[] ins, Charset charset) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File unzip(String zipFilePath) throws Exception {
	 ...
	 * @since 3.2.2
	 */
	public static File unzip(String zipFilePath, Charset charset) throws Exception {
	 ...
	 * @since 3.2.2
	 */
	public static File unzip(File zipFile, Charset charset) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File unzip(String zipFilePath, String outFileDir) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File unzip(String zipFilePath, String outFileDir, Charset charset) throws Exception {
	 ...
	 * @throws Exception IO异常
	 */
	public static File unzip(File zipFile, File outFile) throws Exception {
	...
	public static File unzip(File zipFile, File outFile, Charset charset) throws Exception {
	 ...
	 * @since 4.1.8
	 */
	public static byte[] unzipFileBytes(String zipFilePath, String name)throws Exception  {
	 ...
	 * @since 4.1.8
	 */
	public static byte[] unzipFileBytes(String zipFilePath, Charset charset, String name) throws Exception {
	 ...
	 * @since 4.1.8
	 */
	public static byte[] unzipFileBytes(File zipFile, String name)throws Exception  {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static byte[] unzipFileBytes(File zipFile, Charset charset, String name) throws Exception{
		ZipFile zipFileObj = null;
		try {
			zipFileObj = new ZipFile(zipFile, charset);
			final Enumeration<ZipEntry> em = (Enumeration<ZipEntry>) zipFileObj.entries();
	 ...
	 * @throws Exception IO异常
	 */
	private static void zip(File file, String srcRootDir, ZipOutputStream out) throws Exception {
		if (file == null) {
			return;
		}
	 ...
	 * @since 4.0.5
	 */
	private static void addFile(File file, String path, ZipOutputStream out) throws Exception {
		BufferedInputStream in = null;
		try {
			in = FileUtil.getInputStream(file);
			addFile(in, path, out);
	 ...
	 * @throws Exception IO异常
	 */
	private static void addFile(InputStream in, String path, ZipOutputStream out) throws Exception {
		if (null == in) {
			return;
		}
		try {
	 ...
	 * @throws Exception IO异常
	 */
	private static void addDir(String path, ZipOutputStream out) throws Exception {
	 ...
	 */
	private static void validateFiles(File zipFile, File... srcFiles) throws Exception {
		if(zipFile.isDirectory()) {
			throw new Exception("Zip file [{}] must not be a directory !"+ zipFile.getAbsoluteFile());
		}
		...
		for (File srcFile : srcFiles) {
			...
			if (false == srcFile.exists()) {
				throw new Exception(StrUtil.format("File [{}] not exist!", srcFile.getAbsolutePath()));
			}
